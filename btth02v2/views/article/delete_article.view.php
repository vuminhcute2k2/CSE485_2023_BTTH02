...
<body>
  ...
  <main class="container mt-5 mb-5">
    <div class="row">
      <div class="col-sm">
        <h4 class="text-center text-uppercase fw-bold">Bạn có muốn xóa bài viết <?php echo $id ?> ?</h4>

        <?php include_once("../layouts/arlert.view.php"); ?>
        <form action="process_delete_category.php" method="post">

          <div class="input-group mt-3 mb-3">
            <input type="hidden" class="form-control" name="ma_bviet" value=<?php echo $id ? $id : "" ?>>
          </div>
